...
create table if not exists edw_data (
        id                              serial unique,
        regkey                          varchar(33),
        legal_contract_id               varchar(64),
        sales_order                     varchar(64),
        serial_number                   varchar(64),
        end_customer_name               varchar(256),
        legal_contract_start_date       varchar(64),
        legal_contract_end_date         varchar(64),
